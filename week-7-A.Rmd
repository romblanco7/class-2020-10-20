...
q_resamples2 %>%
  ggplot() +
    geom_histogram(aes(x = mean_hours, 
                       ...
                       binwidth = .05, fill = "dodgerblue", color = "white") +
  labs(title = "Posterior Probability for Mean Hours",
       x = "Mean Hours",
       y = "Probability") +
  theme_bw()


# Most students spend between 6 and 6.4 hours according to qscores.
